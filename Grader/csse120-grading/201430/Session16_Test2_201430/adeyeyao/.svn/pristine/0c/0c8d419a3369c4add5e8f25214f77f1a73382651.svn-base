...
def test_problem1():
    ...
    print('--------------------------------------------------')
    seq1 = [111, 1111, 11111, 111111]
    print('it should print 18: ', problem1(seq1))
    seq2 = [12345, 98765, 444, 100, 9999999999]
    print('it should print 153: ', problem1(seq2))
    seq3 = [58, 3304, 612, 5555, 13, 20010]
    print('it should print 59: ', problem1(seq3))
    seq4 = [30, 11, 1997, 2017 ]
    print('it should print 41: ', problem1(seq4))
