...
class StatisticsForModule(object):
    def __init__(self,
        ...
        # CONSIDER: Data attribute names should match parameter names?
...
def evaluate_module(module_name):
    ...
    contents_wo_docstrings = remove_docstrings(contents)
    contents_wo_docstrings = remove_whitespace_lines(contents_wo_docstrings)

    contents_wo_comments = remove_comments(contents)
    contents_wo_comments = remove_docstrings(contents_wo_comments)
    contents_wo_comments = remove_whitespace_lines(contents_wo_comments)
